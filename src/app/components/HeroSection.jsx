      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            A dedicated Senior Blockchain Engineer based in Natal, Rio Grande do Norte, Brazil. I specialize in developing and optimizing blockchain solutions, driving innovation and efficiency in decentralized networks.
          </p>
          <div>
            <Link
              href="/#projects"
