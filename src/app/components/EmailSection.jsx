...
const EmailSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="z-10">
        <h5 className="text-xl font-bold text-white my-2 text-2xl sm:text-3xl lg:text-4xl">
          Let&apos;s Connect
        </h5>
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/gold-coding">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/mateus-figueiredo-de-melo-avelino-41824a2a4/">
